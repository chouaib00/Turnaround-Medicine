...
@Configuration
@EnableJpaRepositories("com.dwork.rest.server.repository")
...
public class DatabaseConfig {
    ...
    public Properties getHibernateProperties() {
        try {
            ...
            throw new IllegalArgumentException("Can't file hibernate.properties in classpath", e);
        }
    }
    ...
    public DataSource dataSource(){
        ...
        ds.setUrl(env.getRequiredProperty("db.host"));
